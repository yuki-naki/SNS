						...
						<form id="form" method="post" action="chat">
							...
							<button type="submit" class="row sideBar-body">
								<div class="col-xs-1 sideBar-avatar">
									<div class="avatar-icon"><img src="https://bootdey.com/img/Content/avatar/avatar2.png"></div>
								</div>
								<div class="col-xs-11 sideBar-main">
									<div class="row">
										<div id="sideGroupname" data-groupId="${chat.key}" class="col-xs-8 sideBar-name"><span class="name-meta">${chat.value.groupName}</span></div>
			...
			<div class="side-two">
				<div class="row newMessage-heading">
					<div class="row newMessage-main">
						...
						<div class="col-sm-10 col-xs-10 newMessage-title">New Chat
						</div>
					</div>
				</div>
			</div>
