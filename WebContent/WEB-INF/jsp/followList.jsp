...
<body>
	...
	<div class="col-sm-8 col-sm-offset-2 testtest">
					...
					<c:forEach var="user" items="${result}">
						<form method='post' action='removeFollow'>
							...
							<tr>
								...
								<td class="col-xs-1"><input type='submit' class="btn btn-danger " value='Remove'></td><!-- ４番目 -->
							</tr>
						</form>
		...
		<div class="actionButton">
			<a href="getUnFollowList"><button type="button" class="btn btn-success">AddFollow</button></a>
    	</div>
	</div>
</body>
</html>